@can('managers')
    ...
    @section('content')
            ...
            <div class="card-body">
                <div class="card-sub">
                    <form method="GET" class="form-inline row" action="{{ route('blog.search') }}">
                        ...
                        <div class="col-3">
                            <a href="{{ route('blog.create') }}" type="submit" class="btn btn-success"><i
                                ...
                                <td class="text-center">
                                    <form method="post" action="{{ route('blog.destroy', $model->id) }}">
                                        ...
                                        <a class="btn btn-sm btn-secondary btn-detail" href=""><i
                                            ...
                                            tiết</a>
                                        <a class="btn btn-sm btn-primary" href="{{ route('blog.edit', $model->id) }}"><i
        ...
        <!-- Modal staffDetail -->
        <div class="modal fade" id="blogDetail" tabindex="-1" aria-labelledby="blogDetailLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">

                    <div class="modal-header bg-secondary text-white">
                        <h5 class="modal-title" id="blogDetailLabel">Thông tin cá nhân của nhân viên: <span
